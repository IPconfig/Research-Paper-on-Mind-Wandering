...
\newgeometry{left=2.4cm,right=.9cm,bottom=0.0cm, top=0.0cm} % bottom/top will be left/right margin when in landscape
...
% Tail of each repeating table (except last page)
\tabletail{\hline\multicolumn{10}{r}{{Continued on next page}} \\ \hline}

%\xentrystretch{0.10} 

\begin{landscape} % turn the page-layout to landscape
...
\begin{ThreePartTable}
        ...
        \end{tablenotes}
\end{ThreePartTable}
\end{landscape}  % Stop rotating pages to landscape
